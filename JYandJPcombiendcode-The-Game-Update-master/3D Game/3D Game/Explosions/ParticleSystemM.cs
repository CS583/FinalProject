...
namespace _3D_Game
{
    ...
    /// </summary>
    public abstract class ParticleSystemM : DrawableGameComponent
    {
        #region Fields


        // Settings class controls the appearance and animation of this particle system.
        ParticleSettingsM settings = new ParticleSettingsM();
        ...
        /// Constructor.
        /// </summary>
        protected ParticleSystemM(Game game, ContentManager content)
            : base(game)
        {
        ...
        public override void Initialize()
        {
            ...
            particles = new ParticleVertexM[settings.MaxParticles * 4];
        ...
        /// </summary>
        protected abstract void InitializeSettings(ParticleSettingsM settings);
        ...
        protected override void LoadContent()
        {
            ...
            vertexBuffer = new DynamicVertexBuffer(GraphicsDevice, ParticleVertexM.VertexDeclaration,
        ...
        {
            int stride = ParticleVertexM.SizeInBytes;
